...
const triggerNodes: NodeTypeOption[] = [ 
  ...
  { 
    ...
    label: "Stripe Event",
    description: "Executes the Workflow when a Stripe event is detected/captured.",
...
const executionNodes: NodeTypeOption[] = [
  ...
  {
    type: NodeType.SLACK_EXECUTION,  // aka SLACK
    label: "Slack",
    description: "Post a message on a Slack server",
...
export function NodeSelector({ 
  ...
  const handleNodeSelect = useCallback((nodeSelection: NodeTypeOption) => { 
    if (nodeSelection.type === NodeType.MANUAL_TRIGGER) { 
